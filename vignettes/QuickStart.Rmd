...
argument **yesYVal** specifying which level of the factor we wish to be
...
towerOut <- makeTower(engl1,'birth_order','towerKNN')
predict(towerOut,newx,10)
#      Eighth Fifth First Fourth Second Seventh Sixth Third
#           0     0  0.66      0   0.26       0     0  0.08
```

We estimate a 66% chance of First order, and 26% and 8% for Second and
Third.
